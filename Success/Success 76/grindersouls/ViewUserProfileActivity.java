...
public class ViewUserProfileActivity extends AppCompatActivity
{
    ...
    private CollectionReference viewUserProfileReference, friendsRequestReference, notificationsReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewUserProfileReference = FirebaseFirestore.getInstance().collection("Users");

        friendsRequestReference = FirebaseFirestore.getInstance().collection("Friend_Notifications");
        ...
        viewUserProfileReference.document(receiver_user_id).addSnapshotListener(new EventListener<DocumentSnapshot>()
        {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e)
            {
                ...
                if (documentSnapshot != null && documentSnapshot.exists())
                {
                    ...
                    String thumbImage = documentSnapshot.getString("user_img");
                    ...
                    friendsRequestReference.document(sender_user_id).addSnapshotListener(new EventListener<DocumentSnapshot>()
                    {
                        @Override
                        public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e)
                        {
                            ...
                            if (documentSnapshot != null && documentSnapshot.exists())
                            {
                                friendsRequestReference.document(sender_user_id).collection("Send").whereEqualTo(receiver_user_id,true).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>()
                                {
                                    @Override
                                ...
                                friendsRequestReference.document(sender_user_id).collection("Received").whereEqualTo(receiver_user_id,true).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>()
                                {
                                    @Override
                                    public void onComplete(@NonNull Task<QuerySnapshot> task)
                                    {
    ...
    private void SendFriendRequestToAPerson()
    {
        ...
        friendsRequestReference.document(sender_user_id).collection("Sent").document(receiver_user_id).set(time)
                .addOnCompleteListener(new OnCompleteListener<Void>()
                {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            friendsRequestReference.document(receiver_user_id).collection("Received").document(sender_user_id).set(time)
                                    .addOnCompleteListener(new OnCompleteListener<Void>()
                                    {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task)
    ...
    private void AcceptFriendRequest()
    {
        ...
        friendsRequestReference.document(sender_user_id).collection("Friends").document(receiver_user_id).set(time)
                .addOnCompleteListener(new OnCompleteListener<Void>()
                {
                    @Override
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            friendsRequestReference.document(receiver_user_id).collection("Friends").document(sender_user_id).set(time)
                                    .addOnCompleteListener(new OnCompleteListener<Void>()
                                    {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task)
    ...
    protected void onStop()
    {
        ...
        if(currentUser != null)
        {
            FirebaseFirestore.getInstance().collection("Users").document(sender_user_id).update("online", FieldValue.serverTimestamp());
        }
    }
}
