                            ...
                            public void onDataChange(DataSnapshot dataSnapshot)
                            {
                                ...
                                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren())
                                {
                                    ...
                                    if (!otherKey.equals(online_user_id))
                                    {
                                        ...
                                        Toast.makeText(getContext(), "Group Admins "+OtherAdmins.size(), Toast.LENGTH_SHORT).show();
                                    }
...
/*
                                                AlertDialog.Builder deleteGroup = new AlertDialog.Builder(getContext());
                                                deleteGroup.setTitle("Do you want to remove "+ groupName);
                                                ...
                                                deleteGroup.setPositiveButton("Yes", new DialogInterface.OnClickListener()
                                                {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which)
                                                    {
                                                        GroupsReference.child().child(groups).removeValue().addOnCompleteListener(new OnCompleteListener<Void>()
                                                        {
                                                            @Override
