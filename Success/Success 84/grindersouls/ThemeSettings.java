...
public class ThemeSettings extends BaseThemedActivity implements ColorChooserDialog.ColorCallback, ATEActivityThemeCustomizer
{
    ...
    public static class SettingsFragment extends PreferenceFragment
    {
        ...
        void invalidateSettings() {
            mAteKey = ((ThemeSettings) getActivity()).getATEKey();
            ...
            primaryColorPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    new ColorChooserDialog.Builder((ThemeSettings) getActivity(), R.string.primary_color)
            ...
            accentColorPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    new ColorChooserDialog.Builder((ThemeSettings) getActivity(), R.string.accent_color)
            ...
            textColorPrimaryPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    new ColorChooserDialog.Builder((ThemeSettings) getActivity(), R.string.primary_text_color)
            ...
            textColorSecondaryPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    new ColorChooserDialog.Builder((ThemeSettings) getActivity(), R.string.secondary_text_color)
