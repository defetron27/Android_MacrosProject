...
{
    private TextView commentTextView,commentedUserName,commentedTime;
    private View view;
    ...
    CommentsViewHolder(View itemView)
    {
        ...
        commentedTime = itemView.findViewById(R.id.commented_time);
    }

    public void bind(Comments comments)
    {
        String time = LastSeenTime.getTimeAgo(comments.getTime(), view.getContext());

        commentTextView.setText(comments.getComment());
        commentedTime.setText(time);
    ...
    private void setPostedUserImage(final Context context, final String user_thumb_img) {
