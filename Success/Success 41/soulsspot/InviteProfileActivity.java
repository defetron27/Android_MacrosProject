    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getUserDataReference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                if (!thumb_img.equals("default_image"))
                {


                    Picasso.with(InviteProfileActivity.this).load(thumb_img).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.register_user)
                            .into(UserProfileImg, new Callback()
                            {
                                ...
                                public void onError()
                                {
                                    Picasso.with(InviteProfileActivity.this).load(thumb_img).placeholder(R.drawable.register_user).into(UserProfileImg);
                                }
                            });
                }
            }
