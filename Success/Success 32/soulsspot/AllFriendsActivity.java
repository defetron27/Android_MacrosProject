...
public class AllFriendsActivity extends AppCompatActivity
{
    ...
    private ArrayList<String> CountMobileNumber = new ArrayList<>();
    ...
    {
        Toast.makeText(AllFriendsActivity.this,"Searching..", LENGTH_SHORT).show();

        Query searchPeopleAndFriendsToLowerCase = UsersReference.orderByChild("user_name")
                ...
                public void onDataChange(final DataSnapshot dataSnapshot)
                {
                    ...
                    for (String aPhonearray : phonearray)
                    {
                        if (aPhonearray.equals(userMobileNumberWithPlus) || aPhonearray.equals(userMobileNumberWithOutPlus))
                        {
                            ...
                            CountMobileNumber.add(userMobileNumberWithPlus);
                    ...
                    CountMobileNumber.add("0");
                    getSupportActionBar().setSubtitle("    "+CountMobileNumber.size()+" Contacts");
