...
public class GroupsFragment extends Fragment implements ISearch, IDataCallback
{
    ...
    private DatabaseReference CreateGroupUserRef;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        GroupsFab = (FloatingActionButton) view.findViewById(R.id.groups_fab);
        ...
        GroupsFab.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                createGroupIntent.putExtra("online_user_id",online_user_id);
