...
public class CommentsCategoryViewHolder extends ParentViewHolder
{
    ...
    public void bind(CommentsCategory commentsCategory,CommentsCategory commentsCategoryCount)
    {
        mCommentsTextView.setText(commentsCategory.getComment());
        mCommentsCountTextView.setText(commentsCategory.getCommentsCount());
    }
