...
class PhotoFullPopupWindow extends PopupWindow
{
    ...
    ProgressBar loading;
    ViewGroup parent;
    private PhotoFullPopupWindow instance = null;



    PhotoFullPopupWindow(Context ctx, int layout, View v, String imageUrl, Bitmap bitmap) {
        ...
        if (bitmap != null) {
            ...
            GlideApp.with(ctx).asBitmap()
                    .load(imageUrl).error(R.drawable.vadim)
