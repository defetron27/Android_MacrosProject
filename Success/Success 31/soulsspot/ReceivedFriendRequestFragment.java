...
public class ReceivedFriendRequestFragment extends Fragment
{
    ...
    private RecyclerView ReceivedFriendRequestRecyclerView;

    private String online_user_id;

    private FirebaseAuth firebaseAuth;

    private DatabaseReference FriendsRequestsReference,ReceivedFriendRequestUserReference,FriendsRequestReference,FriendsReference,CustomFriendsReference;
    ...
    private void init()
    {
        ReceivedFriendRequestRecyclerView = (RecyclerView) ReceivedFriendRequestView.findViewById(R.id.received_friend_request_recycler_view);
    ...
    private class AllReceivedFriendRequestsUsersAdapter extends RecyclerView.Adapter<AllReceivedFriendRequestsUsersAdapter.ReceivedFriendRequestUsersViewHolder>
    {
        ...
        public AllReceivedFriendRequestsUsersAdapter(ArrayList<String> UserReceivedFriendRequestToFriendKey, Context context)
        {
                                                                                        ...
                                                                                        .addOnCompleteListener(new OnCompleteListener<Void>()
                                                                                        {
                                                                                            ...
                                                                                            public void onComplete(@NonNull Task<Void> task)
                                                                                            {
                                                                                                if(task.isSuccessful())
                                                                                                {
                                                                                                    ...
                                                                                                    CustomFriendsReference.child(sender_user_unique_id).addValueEventListener(new ValueEventListener()
                                                                                                    {
                                                                                                        @Override
                                                                                                        public void onDataChange(DataSnapshot dataSnapshot)
                                                                                                        {
                                                                                                            ...
                                                                                                            ReceivedFriendRequestUserReference.child(sender_user_unique_id).child("friends").setValue(friendscount);
                                                                                                        }
                                                                                                    ...
                                                                                                    ReceivedFriendRequestUserReference.child(sender_user_unique_id).addValueEventListener(new ValueEventListener()
                                                                                                    {
                                                                                                        @Override
                                                                                                        public void onDataChange(DataSnapshot dataSnapshot)
                                                                                                        {
                                                                                                            final String friendName = (String) dataSnapshot.child("user_name").getValue();
                                                                                                            final String friendMobileNumberWithOutPlus = (String) dataSnapshot.child("user_mobile_number_with_out_plus").getValue();

                                                                                                            FriendsReference.child(online_user_id).child(sender_user_unique_id).child("user_name").setValue(friendName);
                                                                                                            FriendsReference.child(online_user_id).child(sender_user_unique_id).child("user_mobile_number_with_out_plus").setValue(friendMobileNumberWithOutPlus)
                                                                                                                    .addOnSuccessListener(new OnSuccessListener<Void>()
                                                                                                                    {
                                                                                                                        @Override
                                                                                                                        public void onSuccess(Void aVoid)
                                                                                                                        {
                                                                                                                            ReceivedFriendRequestUserReference.child(online_user_id).addValueEventListener(new ValueEventListener()
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                public void onDataChange(DataSnapshot dataSnapshot)
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    FriendsReference.child(sender_user_unique_id).child(online_user_id).child("user_name").setValue(userName);
                                                                                                                                    FriendsReference.child(sender_user_unique_id).child(online_user_id).child("user_mobile_number_with_out_plus").setValue(userMobileNumberWithOutPlus);
                                                                                                                                }
                                                                                                    ...
                                                                                                    CustomFriendsReference.child(online_user_id).addValueEventListener(new ValueEventListener()
                                                                                                    {
                                                                                                        @Override
                                                                                                        public void onDataChange(DataSnapshot dataSnapshot)
                                                                                                        {
                                                                                                            ...
                                                                                                            ReceivedFriendRequestUserReference.child(online_user_id).child("friends").setValue(friendscount);
                                                                                                        }
        ...
        public class ReceivedFriendRequestUsersViewHolder extends RecyclerView.ViewHolder
        {
            View v;
            ...
            public ReceivedFriendRequestUsersViewHolder(View itemView)
            {
                super(itemView);

                v = itemView;

                userName = (TextView) v.findViewById(R.id.received_friend_request_user_name);
                acceptFriendRequestButton = (Button) v.findViewById(R.id.request_received_accept_button);
                rejectFriendRequestButton = (Button) v.findViewById(R.id.request_received_decline_button);

                acceptOrRejectLinearLayout = (LinearLayout) v.findViewById(R.id.request_received_accept_or_reject_linear_layout);

            }
            public void setUser_thumb_img(final Context c, final String user_thumb_img)
            {
                final CircleImageView thumb_img = (CircleImageView) v.findViewById(R.id.received_friend_request_user_image);
