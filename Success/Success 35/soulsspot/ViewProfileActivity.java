...
public class ViewProfileActivity extends AppCompatActivity {
    ...
    private void AcceptFriendRequest()
    {
        ...
        ViewUserProfileReference.child(sender_user_id).addValueEventListener(new ValueEventListener()
        {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot)
            {
        ...
        ViewUserProfileReference.child(receiver_user_id).addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                receiver_user_name = (String) dataSnapshot.child("user_name").getValue();
            }
        ...
        FriendsReference.child(sender_user_id).child(receiver_user_id).child("receiver_name").setValue(receiver_user_name)
                .addOnSuccessListener(new OnSuccessListener<Void>()
                {
                    ...
                    public void onSuccess(Void aVoid)
                    {
                        ...
                        FriendsReference.child(receiver_user_id).child(sender_user_id).child("receiver_name").setValue(online_user_name)
                                .addOnSuccessListener(new OnSuccessListener<Void>()
                                {
                                    @Override
                                    public void onSuccess(Void aVoid)
                                                                            ...
                                                                            if(task.isSuccessful())
                                                                            {
                                                                                ViewUserProfileReference.child(receiver_user_id).addValueEventListener(new ValueEventListener()
                                                                                {
                                                                                    ...
                                                                                    public void onDataChange(DataSnapshot dataSnapshot)
                                                                                    {
                                                                                        ...
                                                                                        FriendsReference.child(sender_user_id).child(receiver_user_id).child("user_name").setValue(friendName);
                                                                                        FriendsReference.child(sender_user_id).child(receiver_user_id).child("user_mobile_number_with_out_plus").setValue(friendMobileNumberWithOutPlus)
                                                                                        .addOnSuccessListener(new OnSuccessListener<Void>()
                                                                                        {
                                                                                            @Override
                                                                                            public void onSuccess(Void aVoid)
                                                                                            {
                                                                                                ViewUserProfileReference.child(sender_user_id).addValueEventListener(new ValueEventListener()
                                                                                                {
                                                                                                    ...
                                                                                                    public void onDataChange(DataSnapshot dataSnapshot)
                                                                                                    {
                                                                                                        ...
                                                                                                        FriendsReference.child(receiver_user_id).child(sender_user_id).child("user_name").setValue(userName);
                                                                                                        FriendsReference.child(receiver_user_id).child(sender_user_id).child("user_mobile_number_with_out_plus").setValue(userMobileNumberWithOutPlus);
                                                                                                    }
