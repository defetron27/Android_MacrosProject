...
public class ReceivedFriendRequestFragment extends Fragment
{
    ...
    private DatabaseReference CustomFriendsReference;
    ...
    private void loadData()
    {
        ...
        DatabaseReference friendsRequestsReference = FirebaseDatabase.getInstance().getReference().child("Friend_Requests").child(online_user_id);
                ...
                public void onDataChange(DataSnapshot dataSnapshot)
                {
                    ...
                    holder.acceptFriendRequestButton.setOnClickListener(new View.OnClickListener()
                    {
                        ...
                        public void onClick(View v)
                        {
                            ...
                            if (sender_user_unique_id != null) {
                                FriendsReference.child(online_user_id).child(sender_user_unique_id).child("receiver_name").setValue(userSenderName)
                                        .addOnSuccessListener(new OnSuccessListener<Void>()
                                        {
                                            ...
                                            public void onSuccess(Void aVoid)
                                            {
                                                ...
                                                FriendsReference.child(sender_user_unique_id).child(online_user_id).child("receiver_name").setValue(online_user_name)
                                                        .addOnSuccessListener(new OnSuccessListener<Void>()
                                                        {
                                                            @Override
                                                            public void onSuccess(Void aVoid)
