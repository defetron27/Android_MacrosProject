            ...
            public void onClick(View v)
            {
                if (uri != null)
                {
                    if (Type.equals("single"))
                    {
                        ...
                        {
                            storeSingleGifDetails(online_user_id, ReceivedIds, uri, MessagesModel.MESSAGE_TYPE_GIF);
                    ...
                    else if (Type.equals("group"))
                    {
                        ...
                        {
                            storeGroupGifDetails(online_user_id, ReceivedIds, uri, GroupKey, MessagesModel.MESSAGE_TYPE_GIF);
