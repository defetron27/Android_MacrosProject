...
public class FriendsFragment extends Fragment
{
    ...
    public void onViewCreated(@NonNull View mainView, @Nullable Bundle savedInstanceState)
    {
        ...
        YouHaveNoFriends = (TextView) mainView.findViewById(R.id.you_have_no_friends);

        FriendsFab = (FloatingActionButton) mainView.findViewById(R.id.friends_fab);
    ...
    private void loadData()
    {
        ...
        FriendsReference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                for (DataSnapshot single: dataSnapshot.getChildren())
                {
                    ...
                    String date = (String) single.child("date").getValue();

                    UserFriendsKey.add(single.getKey());

                    FriendsDate.add(date);
                }
                ...
                if (UserFriendsKey.size() == 0)
                {
                    ...
                    UserFriendRecyclerView.setVisibility(View.INVISIBLE);
                }
            }
        ...
        FriendsFab.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent allFriendsIntent = new Intent(getContext(),AllFriendsActivity.class);
    ...
    private class AllUserFriendsAdapter extends RecyclerView.Adapter<AllUserFriendsAdapter.UserFriendsViewHolder>
    {
        ...
        public void onBindViewHolder(@NonNull final UserFriendsViewHolder holder, int position)
        {
            ...
            final int userKeySize = UserFriendKey.size();
