...
public class LikeButton extends FrameLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        iconWidth = array.getDimensionPixelSize(R.styleable.LikeButton_icon_width, -1);
        iconHeight = array.getDimensionPixelSize(R.styleable.LikeButton_icon_height, -1);
    ...
    public void setIconSizeDp(int iconWidth, int iconHeight)
    {
        setIconSizePx((int) Utils.dipToPixels(getContext(), (float) iconWidth),(int) Utils.dipToPixels(getContext(), (float) iconHeight));
    }

    public void setIconSizePx(int iconWidth, int iconHeight)
    {
