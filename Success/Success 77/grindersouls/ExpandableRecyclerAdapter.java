        ...
        extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ParentViewHolder.ParentListItemExpandCollapseListener
{
    ...
    ExpandableRecyclerAdapter(ArrayList<? extends ParentArrayListItem> parentItemList)
    {
        super();
    ...
    public abstract void onBindParentViewHolder(PVH parentViewHolder, int position, ParentArrayListItem parentListItem);
