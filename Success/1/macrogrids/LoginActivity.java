...
public class LoginActivity extends AppCompatActivity
{
    ...
    private DatabaseReference ExistUserReference;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ExistUserReference = FirebaseDatabase.getInstance().getReference().child("Users");


        LoginToolbar = (Toolbar) findViewById(R.id.login_toolbar);
        setSupportActionBar(LoginToolbar);
        getSupportActionBar().setTitle("Already an Macro-s User");
                    ...
                    CheckDataReference.child("Users").child(online_user_id).addListenerForSingleValueEvent(new ValueEventListener()
                    {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot)
                        {
                            if (dataSnapshot.getValue() != null)
                            {
                                ...
                                ExistUserReference.child(online_user_id).child("device_token").setValue(DeviceToken)
                            ...
                            {
                                Toast.makeText(LoginActivity.this, "Your Account Doesn't Exist in Macro-s, Please Try New User", Toast.LENGTH_SHORT).show();
                            }
