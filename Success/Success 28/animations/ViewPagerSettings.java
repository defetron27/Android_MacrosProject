...
public class ViewPagerSettings extends AppCompatActivity
{
    ...
    {
        RadioGroup group = (RadioGroup)findViewById(R.id.radio_group_transformers_list);

        String[] transformers = getResources().getStringArray(R.array.pagertransformer_list);

        for (int i = 0; i < transformers.length; i++)
        {
            final String transformer = transformers[i];
            ...
            button.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    Toast.makeText(ViewPagerSettings.this, "You Clicked " + transformer, Toast.LENGTH_SHORT).show();
