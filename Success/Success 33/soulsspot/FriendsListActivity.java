        ...
        CreateGroupUsingSelectedMembersButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if (selectedFriendsToSend.size() > 0)
                {
                    ...
                    final String groupsCount = String.valueOf(countGroups.size());


                    if (groupsCount.equals("0"))
                    {
                        countGroups.clear();
                        GroupRef.child("1").child("group_profile_image").setValue("default_group_profile_image");
                        GroupRef.child("1").child("group_profile_thumb_image").setValue("default_group_profile_thumb_image").addOnCompleteListener(new OnCompleteListener<Void>()
                        {
                            @Override
                    ...
                    else
                    {
                        ...
                        final String groupsCount1 = String.valueOf(countGroups.size());

                        GroupRef.child(groupsCount1).child("group_profile_image").setValue("default_group_profile_image");
                        GroupRef.child(groupsCount1).child("group_profile_thumb_image").setValue("default_group_profile_thumb_image").addOnCompleteListener(new OnCompleteListener<Void>()
                        {
                            @Override
                            public void onComplete(@NonNull Task<Void> task)
                            {
