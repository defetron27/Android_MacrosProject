...
public class LoginActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        LoginUserMobileNumber = (AppCompatEditText)findViewById(R.id.login_user_mobile_number);
        ...
        LoginUserMobileCodeCountDown = (CountDownView) findViewById(R.id.login_user_mobile_code_count_down);
                    ...
                    CheckDataReference.child("Users").child(online_user_id).addListenerForSingleValueEvent(new ValueEventListener()
                    {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot)
                        {
                            ...
                            else
                            {
                                ...
                                storeUserDefaultDataReference.child(online_user_id).child("user_have_groups").setValue("0");
