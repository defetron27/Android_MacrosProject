...
public class MessageTypesModel
{
    ...
    public MessageTypesModel(String message, int type, String time, boolean seen, String from, String ref, String size, String key, String duration, String exe, String file_name, Timestamp date, String pdf_thumbnail, String today_date) {
