...
public class PostsFragment extends Fragment
{
                ...
                for (final String member : Friends)
                {
                    FriendsPostsReference.child(member).addValueEventListener(new ValueEventListener()
                    {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot)
                        {
                            ...
                            {
                                MultiRecyclerModel model = snapshot1.getValue(MultiRecyclerModel.class);
    ...
    private class AllPostsAdapter extends RecyclerView.Adapter
    {
        ...
        AllPostsAdapter(Context context, ArrayList<MultiRecyclerModel> Posts, ArrayList<String> FriendsKey)
        {
            ...
            if (object != null)
            {
                switch (object.getType())
                {
                    case 0:
                        ...
                        FriendsPostsReference.child(key).child(object.getPost_key()).addValueEventListener(new ValueEventListener()
                        {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot)
                            {
                                ...
                                if (result == null)
                                {
                                    ...
                                    final File localFile = new File(Environment.getExternalStorageDirectory()
                                            + "/" + "GrindersSouls/GrindersSouls Posts", "Images");
                    ...
                    case 1:
                        ...
                        FriendsPostsReference.child(key).child(object.getPost_key()).addValueEventListener(new ValueEventListener()
                        {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot)
                            {
                                ...
                                GlideApp.with(context).load(object.getStorage_ref()).centerCrop().into(((PostVideoTypeViewHolder) holder).videoThumbImage);
