        ...
        public void onBindViewHolder(@NonNull final GroupProfileMembersViewHolder holder, int position)
        {
            ...
            GroupMembersReference.child(members).addValueEventListener(new ValueEventListener()
            {
                ...
                public void onDataChange(DataSnapshot dataSnapshot)
                {
                    ...
                    {
                        if (OtherAdmins.get(i).equals(members))
                        {
                            holder.adminTextView.setVisibility(View.VISIBLE);
                        }
                    }
                    ...
                    holder.view.setOnClickListener(new View.OnClickListener()
                    {
                        ...
                        public void onClick(View v)
                        {
                            if (AdminKey.equals(online_user_id) || AdminKey.equals(members))
                            {
                                ...
                                else
                                {
                                    ...
                                    Toast.makeText(c, "Remove  "+ memberName, Toast.LENGTH_SHORT).show();
                                ...
                                builder.setItems(options, new DialogInterface.OnClickListener()
                                {
                                    ...
                                    {
                                        if (dialog.equals(memberName + "'s Profile"))
                                        {
                                        ...
                                        if (which == 2)
                                        {
                                            if (memberName != null)
                                            {
                                                GroupRef.child(AdminKey).child(GroupPosition).child("group_admin").child(memberName).setValue(memberUniqueId).addOnCompleteListener(new OnCompleteListener<Void>()
                                                {
                                                    @Override
                                                    public void onComplete(@NonNull Task<Void> task)
                                                    {
                                                        Toast.makeText(ViewGroupProfileActivity.this, "Group Admin" + memberName, Toast.LENGTH_SHORT).show();
                                                    }
                                                });

                                            }
                                        }
                                        if (dialog.equals("Remove "+ memberName))
                                        {
                            ...
                            else
                            {
                                ...
                                if (!(OtherAdmins.size() == 0))
                                {
                                    for (int i=0; i<OtherAdmins.size(); i++)
                                    {
                                        if (OtherAdmins.get(i).equals(members) || OtherAdmins.get(i).equals(AdminKey))
                                        {
                                            options = new CharSequence[]
                                                    {
                                                            memberName + "'s Profile",
