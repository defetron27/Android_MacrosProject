            ...
            if (admin.equals("admin"))
            {
                CreatedGroupsReference.child(groups).addValueEventListener(new ValueEventListener()
                {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        ...
                        String CountedNextAdminGroups = null;

                        if (OtherAdmins.size() == 1)
                        {
                            nextAdmin = OtherAdmins.get(0);
                            ...
                            GroupsReference.child(nextAdmin).addValueEventListener(new ValueEventListener()
                            {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot)
                                {
                                    ...
                                    for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren())
                                    {
                                        ...
                                        Toast.makeText(context, "Next " +NextAdminGroupsCount.toString(), Toast.LENGTH_LONG).show();
                                    }
                                }
                            ...
                            CountedNextAdminGroups = String.valueOf(NextAdminGroupsCount.size());
                        ...
                        final String finalNextAdmin = nextAdmin;
                        final String finalCountedNextAdminGroups = CountedNextAdminGroups;
                                        ...
                                        switch (item.getItemId())
                                        {
                                            ...
                                            case R.id.action_exit_group:
                                                ...
                                                else if (OtherAdmins.size() == 1)
                                                {
                                                    ...
                                                    Toast.makeText(context, "Next " + finalNextAdmin, Toast.LENGTH_LONG).show();
                                                                                            ...
                                                                                            if (task.isSuccessful())
                                                                                            {
                                                                                                CreatedGroupsReference.child(groups).child("group_admin").updateChildren(NewAdmins).addOnCompleteListener(new OnCompleteListener<Void>()
                                                                                                {
                                                                                                    ...
                                                                                                    public void onComplete(@NonNull Task<Void> task)
                                                                                                    {
                                                                                                        if (task.isSuccessful())
                                                                                                        {
                                                                                                            Toast.makeText(context, "Next Admin " + finalNextAdmin, Toast.LENGTH_SHORT).show();
                                                                                                            Toast.makeText(context, "Counted Groups " + finalCountedNextAdminGroups, Toast.LENGTH_SHORT).show();

                                                                                                            GroupsReference.child(finalNextAdmin).child(finalCountedNextAdminGroups).child("date").setValue(saveCurrentDate);
                                                                                                            GroupsReference.child(finalNextAdmin).child(finalCountedNextAdminGroups).child("new_group_name").setValue(groupName);
                                                                                                            GroupsReference.child(finalNextAdmin).child(finalCountedNextAdminGroups).child("group_profile_image").setValue("default_group_profile_image");
                                                                                                            GroupsReference.child(finalNextAdmin).child(finalCountedNextAdminGroups).child("group_profile_thumb_image").setValue("default_group_profile_thumb_image");
                                                                                                            GroupsReference.child(finalNextAdmin).child(finalCountedNextAdminGroups).child("group_admin").updateChildren(NewAdmins);
                                                                                                            GroupsReference.child(finalNextAdmin).child(finalCountedNextAdminGroups).child("no_of_new_group_members").updateChildren(NewMembers).addOnCompleteListener(new OnCompleteListener<Void>()
                                                                                                            {
                                                                                                                @Override
                                                                                                                public void onComplete(@NonNull Task<Void> task)
                                                                                                                {
