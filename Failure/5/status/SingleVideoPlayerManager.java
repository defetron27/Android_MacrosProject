...
public class SingleVideoPlayerManager implements VideoPlayerManager<MetaData>, VideoPlayerManagerCallback, MediaPlayerWrapper.MainThreadMediaPlayerListener {
    ...
    @Override
    public void playNewVideo(MetaData currentItemMetaData, VideoPlayerView videoPlayerView, Uri videoUri,Context context)
    {
        ...
        boolean isAlreadyPlayingTheFile =
                mCurrentPlayer != null &&
                        videoUri.equals(mCurrentPlayer.getVideoUriDataSource());
        ...
        if(currentPlayerIsActive){
            if(isInPlaybackState() && isAlreadyPlayingTheFile){
                ...
                /** 4. */
                startNewPlayback(currentItemMetaData, videoPlayerView, videoUri,context);
            }
        } else {
            /** 4. */
            startNewPlayback(currentItemMetaData, videoPlayerView, videoUri,context);
        ...
        if(SHOW_LOGS) Logger.v(TAG, "<< playNewVideo, videoPlayer " + videoPlayerView + ", videoUrl " + videoUri);
    }
    ...
    private void startNewPlayback(MetaData currentItemMetaData, VideoPlayerView videoPlayerView, Uri videoUri,Context context)
    {
        ...
        stopResetReleaseClearCurrentPlayer();
        setNewViewForPlayback(currentItemMetaData, videoPlayerView);
        startPlayback(videoPlayerView, videoUri,context);
    }
    ...
    private void startPlayback(VideoPlayerView videoPlayerView, Uri videoUri,Context context)
    {
        ...
        mPlayerHandler.addMessages(Arrays.asList(
                ...
                new SetUriDataSourceMessage(videoPlayerView, videoUri, context, this),
