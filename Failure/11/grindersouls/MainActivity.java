...
public class MainActivity extends BaseThemedActivity implements NavigationView.OnNavigationItemSelectedListener,NetworkStateReceiver.NetworkStateReceiverListener
{
    ...
    protected void onResume()
    {
        ...
        GrinderSoulsApp_Offline.getInstance().setConnectionListener(this);
    ...
    public void onNetworkConnectionChanged(boolean isConnected)
    {
        if (isConnected)
        {
            ...
            Snackbar.make(findViewById(R.id.drawerLayout),"Network Connection Established",Snackbar.LENGTH_LONG).show();
        }
        else
        {
            Toast.makeText(this, "Network Connection Not Established", Toast.LENGTH_SHORT).show();
            Snackbar.make(findViewById(R.id.drawerLayout),"Network Connection Not Established",Snackbar.LENGTH_LONG).show();
        }
    }
            ...
            public void run()
            {
                switch (mItemId)
                {
                    ...
                    case R.id.nav_item_upload_today_post:
                        ...
                        break;
                    case R.id.nav_item_mind_free:
                        startActivity(new Intent(MainActivity.this,MindFreeActivity.class));
                        break;
                }
            }
        },75);
